-- ============================================================================
-- DOKAN — Fix: include business logo_url in the public menu RPC so the
-- customer-facing QR menu can show the real logo instead of a letter avatar.
-- ============================================================================
...
begin
  ...
  select jsonb_build_object(
    'business', (select jsonb_build_object('id', id, 'name', name, 'currency', currency, 'tax_rate', tax_rate, 'logo_url', logo_url)
